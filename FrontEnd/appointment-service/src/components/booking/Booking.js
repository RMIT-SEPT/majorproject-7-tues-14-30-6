...
const API_BOOKING_URL =
  BASE_URL + "/api/bookings?past=false&current=true&customer=";
    ...
    axios
      ...
      .then(
        (data) => {
          ...
          data.sort(
            (a, b) => new Date(a.bookingDateTime) - new Date(b.bookingDateTime)
          );
      ...
      return (
        <div id="main">
          <h4 className="display-5 text-center">
            Only logged in users can view/make a booking!
          </h4>
        </div>
      );
    }
    ...
    return (
      <div id="main">
        ...
        <h6 className="display-5 text-center">
          On this page, you can view all your upcoming bookings and also create
          new bookings
        </h6>
        ...
        <p id="bottomText">
          * We only offer services for <b>Dan's Dentist</b> and{" "}
          <b>Bob's Bowling Ally</b> at this moment
        </p>
      </div>
    );
  }
